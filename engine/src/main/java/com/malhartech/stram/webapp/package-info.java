 ...
 * <b>Application Information</b>: Provides application level data like user, appId, elapsed time, etc.<br>
 * <b>Node Information</b>: Provides data on the data node. This includes throughput, container id etc.<br>
 * <b>Dag Nodes Information</b>: Provides data on all the nodes of the data.<br>
 * <b>Stream Information</b>: TBD<br>
 * <b>Access and Authoriation</b>: TBD
 * 
 */
