/**
 * Copyright (c) 2005, 2010-2013 Malhar, Inc.
 * All rights reserved.
 */
...
public class DNodeManagerTest {
  ...
  public void testAssignContainer() {
    ...
    StreamingContainerContext c1 = dnm.assignContainer(container1Id);
    ...
    StreamingContainerContext c2 = dnm.assignContainer(container2Id);
