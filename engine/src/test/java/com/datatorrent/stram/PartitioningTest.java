...
public class PartitioningTest
{
  ...
  public static class PartitionableInputOperator extends BaseOperator implements InputOperator, Partitionable<PartitionableInputOperator>
  {
    ...
    @Override
    public Collection<Partition<PartitionableInputOperator>> definePartitions(Collection<? extends Partition<PartitionableInputOperator>> partitions, int incrementalCapacity)
    {
