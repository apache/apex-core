...
public class StreamingContainerManagerTest {
  ...
  public void testStaticPartitioning() {
    ...
    try {
      InputStream stream = new HdfsStorageAgent(new Configuration(false), dag.getAttributes().get(DAGContext.APPLICATION_PATH) + "/" + DAGContext.SUBDIR_CHECKPOINTS).getLoadStream(mergeNodeDI.id, -1);
