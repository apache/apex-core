...
public interface AttributeMap
{
   ...
   * Since the AttributeKey does not have access to the key type at runtime
  ...
  public static class AttributeKey<T>
  {
    ...
    public AttributeKey(T defaultValue)
    {
      if (defaultValue == null) {
        throw new IllegalArgumentException("Attribute cannot have null value, please pass typed null instead");
      }
